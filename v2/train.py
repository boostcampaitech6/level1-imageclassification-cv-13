...
def train(data_dir, model_dir, args):
    ...
    if args.model == "vit_large_patch32_384":
        import timm
    ...
    for epoch in range(args.epochs):
        ...
        for idx, train_batch in enumerate(train_loader):
            ...
            loss1 = criterion1(outs, labels)
            loss2 = criterion2(outs, labels)
            loss3 = criterion3(outs, labels)
            loss4 = criterion4(outs, labels)
