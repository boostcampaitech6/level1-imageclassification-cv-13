...
def inference(data_dir, model_dir, output_dir, args):
    ...
    with torch.no_grad():
        for idx, images in enumerate(loader):
            ...
            pred = dataset.encode_multi_class(mask_preds, gender_preds, age_preds)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default=os.environ.get("SM_CHANNEL_EVAL", "/data/ephemeral/mask/eval"),
    )
    parser.add_argument(
        "--model_dir",
        type=str,
        default=os.environ.get("SM_CHANNEL_MODEL", "./exp"),
    )
    parser.add_argument(
        "--output_dir",
        type=str,
