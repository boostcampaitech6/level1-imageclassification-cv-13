...
class RandAugmentation:
    def __init__(self, resize, mean, std, **args):
        self.transform = Compose(
            [
                Resize(resize, Image.BILINEAR, antialias=True),
                CenterCrop(resize),
                RandomHorizontalFlip(),
...
class RegNetAugmentation:
    """RegNet Augmentation을 담당하는 클래스"""
...
class ViT_L_16Augmentation:
    """ViT_L_16 Augmentation을 담당하는 클래스"""
...
class ResNet50Augmentation:
    """ResNet50 Augmentation을 담당하는 클래스"""
